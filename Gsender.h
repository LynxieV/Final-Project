...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "U2FmZUFuZFNvdW5kR1dDQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "Z2lybHN3aG9jb2Rl";
        const char* FROM = "SafeAndSoundGWC@gmail.com";
